...
class CircularProgressBar: UIView {
    ...
    private func drawBackgroundLayer(){
        let path1 = UIBezierPath(arcCenter: pathCenter, radius: self.radius, startAngle: 0, endAngle: 2*CGFloat.pi, clockwise: true).cgPath
        let path2 = UIBezierPath(arcCenter: pathCenter, radius: self.radius*2/3, startAngle: 0, endAngle: 2*CGFloat.pi, clockwise: true).cgPath
        let path3 = UIBezierPath(arcCenter: pathCenter, radius: self.radius/3, startAngle: 0, endAngle: 2*CGFloat.pi, clockwise: true).cgPath
    ...
    private func drawForegroundLayer(){
        ...
        let path1 = UIBezierPath(arcCenter: pathCenter, radius: self.radius, startAngle: startAngle, endAngle: endAngle, clockwise: true).cgPath
        let path2 = UIBezierPath(arcCenter: pathCenter, radius: self.radius*2/3, startAngle: startAngle, endAngle: endAngle, clockwise: true).cgPath
        let path3 = UIBezierPath(arcCenter: pathCenter, radius: self.radius/3, startAngle: startAngle, endAngle: endAngle, clockwise: true).cgPath
